...
const MyClassDetails = () => {
  ...
  return (
    <div>
      ...
      <section className="md:p-6 my-6 font-poppins bg-base-100 md:bg-base-300 rounded-xl">
        <div className="container grid  mx-auto md:grid-cols-2 gap-5">
          ...
          <div className="flex border bg-base-100  p-3 rounded-lg items-center gap-5">
            <div className="">
              <img
                className="w-28 object-contain h-28"
          ...
          <div className="hidden md:flex border bg-base-100  p-3 rounded-lg items-center gap-5">
            <div className="">
              <img
                className="w-28  h-28"
