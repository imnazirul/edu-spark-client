const NewsLetter = () => {
  return (
    <>
      <div className="w-full bg-gray-400 mt-8 lg:mt-16 rounded-xl bg-[url('https://source.unsplash.com/random/640x480')] bg-fixed bg-center bg-blend-multiply bg-cover">
