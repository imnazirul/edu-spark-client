      ...
      <div className="navbar px-5 lg:px-10 fixed backdrop-blur-xl container  z-50 mx-auto font-poppins   justify-between">
        <div className="md:navbar-start  items-center">
          <div className="dropdown z-20">
            ...
            <div
              tabIndex={0}
              className=" menu menu-sm gap-4 dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 md:w-64 border border-secondary-1 py-5 md:text-lg md:py-7 "
            >
              {navLinks}
            </div>
          </div>
